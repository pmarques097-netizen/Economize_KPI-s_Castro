...
SELECT DISTINCT
    ...
    inf.valorunitario::numeric(18, 6) AS valorunitario_bruto,
    inf.custo::numeric(18, 6) AS custo_bruto,
    inf.acrescimo::numeric(18, 6) AS acrescimo_bruto,
    inf.quantidade::numeric(18, 6) AS quantidade_bruta,
    (
        inf.valorunitario /
